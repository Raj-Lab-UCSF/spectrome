...
def create_turbo_colormap():
    """Rainbow colormap created by Anton Mikhailov, see Google's blog post on this:https://ai.googleblog.com/2019/08/turbo-improved-rainbow-colormap-for.html
    
    Returns:
        turbo [colormap]: Colormap for matplotlib.
    """
    # color map
    turbo_colormap_data = [
